...
- [ ] For EACH folder, run `ls AGENTS/Phase 1 - Foundation/` to confirm README.md AND CHECKLIST.md exist
...
```
⚠️ ISSUE DETECTED: Phase folder "Phase 1 - Foundation" is missing or incomplete.
- Missing: TBD
- Action required: TBD
```
...
1. For EACH phase defined in the PRD, create folder: `AGENTS/Phase X - Product Requirements Document (PRD)/`
2. Copy `AGENTS_templates/PHASE_TEMPLATE/README.md` to EACH `AGENTS/Phase 1 - Foundation/README.md`
3. Copy `AGENTS_templates/PHASE_TEMPLATE/CHECKLIST.md` to EACH `AGENTS/Phase 1 - Foundation/CHECKLIST.md`
4. Update placeholders in the copied files:
   - `Phase 1 - Foundation` → "1", "2", "3", "4", "5" etc.
   - `Phase 1 - Foundation` → "Phase 1 - Foundation", "Phase 2 - Implementation", etc.
   - `## 1. Project Overview
...
- **Target Audience:** YouTube users who want to identify and avoid content from private equity-owned channels` → Brief phase goal
