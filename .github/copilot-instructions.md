# YouTube Private Equity Warning Extension Copilot Workflow Instructions
...
- Before formulating any response or execution plan, read:
  ...
  - `AGENTS/Phase 1 - Foundation/README.md`
...
- When the user issues the exact phrase: "Install Agentic Brain for this repository." the Copilot assistant **must** perform the scaffolding step according to the following flow (no manual CLI steps required from the user):
  ...
  3. Run the scaffolding script with EXPLICIT target path: `node scripts/scaffold-agentic-brain.mjs --target "C:\Users\user\Desktop\Documentations\github\anti-private-equity-slop"` - YOU MUST SPECIFY THE TARGET, do not rely on default or current directory.
...
- Read .github/copilot-instructions.md  Phase 1 - Foundation/README.md
- Read AGENTS/Phase 1 - Foundation/CHECKLIST.md
...
- If present, read AGENTS/Phase 1 - Foundation/AGENTS/agents-orchestrator.agent.md.md
```
...
- This block must read exactly as:
  ...
  Read AGENTS/Phase 1 - Foundation/README.md
  Read AGENTS/Phase 1 - Foundation/CHECKLIST.md
  Read .github/agent_memory/00_index.md
  Read .github/agent_memory/01_decisions.md
  Read .github/agent_memory/02_learnings.md
